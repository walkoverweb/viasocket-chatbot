...
// function AllInterfaceList({
//   projectId,
//   interfaceId,
//   orgId,
// }: AllInterfaceListPropTypes) {
//   const dispatch = useDispatch();
//   const navigate = useNavigate();
//   const [renameInterfaceId, setRenameInterfaceId] = useState<string | null>(
//     null
//   );
...
//     return allInterfaceArr.filter(
//       (interfaceObj) => interfaceObj?.projectId === projectId
//     );
...
//       return;
//     }
//     const isNameExists = filteredInterfaces.some(
//       (interfaceObj) => interfaceObj.title === newInterfaceName
//     );
//     if (isNameExists) {
//       setRenameInterfaceId(null);
...
//     dispatch(
//       updateInterfaceDetailsStart({
//         interfaceId: renameInterfaceId,
//         title: newInterfaceName,
//       })
//     );
//     setRenameInterfaceId(null);
//   };
...
//         dispatch(
//           deleteInterfaceStart({
//             interfaceId: projectInfo?.interfaceId,
//             navigateToInterface,
//           })
//         );
//         break;
...
//         <Typography variant="smallHeading" className="px-1">
//           Interfaces
//         </Typography>
...
//                 (interfaceObj: InterFaceDataType, index: number) => {
//                   return (
//                     <ListItem
//                       disablePadding
...
//                             onKeyDown={(e) => {
//                               if (e.key === "Enter")
//                                 handleRenameInterface(e, interfaceObj?.title);
//                             }}
//                             onBlur={(e) =>
//                               handleRenameInterface(e, interfaceObj?.title)
//                             }
...
//                             componentDetails={{
//                               index,
//                               interfaceId: interfaceObj?._id,
//                               title: interfaceObj?.title,
//                             }}
//                             interface
//                           />
//                         </ListItemButton>
...
//   addUrlDataHoc(React.memo(AllInterfaceList), [
