...
//     data: state?.Interface?.interfaceData?.[interfaceId]?.components?.[
//       componentDetails?.gridId
//     ]?.[componentDetails?.componentId]?.props,
//     actionData:
//       state?.Interface?.interfaceData?.[interfaceId]?.actions?.[
//         componentDetails?.gridId
...
//     const responseId = `Response${(Math.random() + uniqueTime)
//       .toString(36)
//       .slice(2, 7)}`;
...
//     const isResPresent = actionData?.responseArr?.some(
//       (action: any) => action.type === "chatbot"
//     );
//     const updatedResponseArr = isResPresent
//       ? actionData?.responseArr.map((action: any) =>
//           action.type === "chatbot" ? { ...action, responseId } : action
//         )
//       : [
//           ...(actionData?.responseArr || []),
//           { responseId: responseId, description: "", components: {} },
//         ];
...
//       return response;
//     });
//     const updatedResponseArr = actionData?.responseArr.filter(
...
//     const updatedResponseArr = (actionData?.responseArr || []).map(
//       (response) => {
...
//               <Typography className="text-overflow-eclipse propName">
//                 {propName}:
//               </Typography>
...
//               <Button
//                 variant="contained"
//                 onClick={() => onAddNewResponse(componentDetails?.componentId)}
//               >
//                 Add Response +
//               </Button>
//             </Box>
...
//   addUrlDataHoc(React.memo(ConfigurationTab), [ParamsEnums?.interfaceId])
// );
