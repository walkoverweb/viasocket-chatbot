...
import { defaultStyle, iterateMentionsMarkup, mapPlainTextIndex, readConfigFromChildren, isNumber } from './utils'
...
function Highlighter({ selectionStart, selectionEnd, value = '', onCaretPositionChange, containerRef, children, style }) {
