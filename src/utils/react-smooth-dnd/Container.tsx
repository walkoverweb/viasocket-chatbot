...
import { dropHandlers, smoothDnD as container, ContainerOptions, SmoothDnD } from './smooth-dnd/index.ts'
...
class Container extends Component<ContainerProps> {
  ...
  render() {
    ...
    return (
      <div style={this.props.style} className={this.props?.className || ''} ref={this.containerRef}>
        {this.props.children}
      </div>
    )
  }
