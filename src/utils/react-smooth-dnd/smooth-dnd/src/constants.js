...
export const translationValue = '__dndrop_draggable_translation_value'
export const visibilityValue = '__dndrop_draggable_visibility_value'
...
export const defaultResponse = { data: { success: true }, message: 'Flow Queued', flowHitId: 'flow hit ID' }
